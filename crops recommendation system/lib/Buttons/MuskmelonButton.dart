...
class MuskmelonButton extends StatelessWidget {
  const MuskmelonButton({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Image.asset(
                'assets/muskmelon.png', // Path to the rice image
                height: 200,
