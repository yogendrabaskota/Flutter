...
class PomegranateButton extends StatelessWidget {
  const PomegranateButton({Key? key}) : super(key: key);
...
class RicePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Pomegranate Details'),
      ),
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Image.asset(
                'assets/pomegranate.png', // Path to the rice image
