...
class WatermelonButton extends StatelessWidget {
  const WatermelonButton({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Image.asset(
                'assets/watermelon.png', // Path to the rice image
